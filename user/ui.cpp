...
ICACHE_FLASH_ATTR void drawWireFrame()
{
	...
	//Target placeholder
	//drawPlaceholder(0, 0, 100, 60, VGA_RED, "TARGET");
	drawPlaceholder(0, 0, 133, 78, VGA_RED, "RABBY");
	
	//Temperatures placeholder
	int placeholderbody = drawPlaceholder(135, 0, 184, 78, VGA_GREEN, "AIR");
	//int placeholderbody = drawPlaceholder(100, 0, 160, 60, VGA_GREEN, "AIR");
	...
	//placeholderbody = drawPlaceholder(100, 80, 160, 60, VGA_PURPLE, "WATER");
